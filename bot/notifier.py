...
class TelegramNotifier:
    def __init__(self, bot_token=None, chat_id=None):
        ...
        self.token = bot_token if bot_token and "your_bot_token_here" not in bot_token else None
        self.chat_id = chat_id if chat_id and "your_chat_id_here" not in chat_id else None
